...
extension PandaNetwork: PandaNetworkProtocol {
    ...
    private func fetchTeamPlayers(teamID: String) async throws -> [Player] {
        return try await getRequest.get(urlString: "https://api.pandascore.co/csgo/players",
                                        queryItems: [URLQueryItem(name: "token",
                                                                  value: "ynq2OlKndvM584ijPWI1l03cK-9EUUTd60IE_vhWPWj_aza4yLE"),
    ...
    private func fetchRunningMatch() async throws -> [Match] {
        return try await getRequest.get(urlString: "https://api.pandascore.co/csgo/matches/running",
                                        queryItems: [URLQueryItem(name: "token",
                                                                  value: "ynq2OlKndvM584ijPWI1l03cK-9EUUTd60IE_vhWPWj_aza4yLE")],
                                        httpMethod: .get,
                                        parser: [Match].self)
    ...
    private func fetchUpcomingMatches(pageIndex: Int) async throws -> [Match] {
        return try await getRequest.get(urlString: "https://api.pandascore.co/csgo/matches/upcoming",
                                        queryItems: [URLQueryItem(name: "token",
                                                                  value: "ynq2OlKndvM584ijPWI1l03cK-9EUUTd60IE_vhWPWj_aza4yLE"),
